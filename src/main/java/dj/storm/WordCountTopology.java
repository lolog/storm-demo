...
import dj.storm.bolt.SplitSentenceBolt;
import dj.storm.bolt.WordCountBolt;
...
public class WordCountTopology 
{
    public static void main( String[] args) throws Exception {
    	String outFileName = "word-count-topology.out";
         ...
         */
        builder.setBolt("count", new WordCountBolt(), 3).fieldsGrouping("split", new Fields("split-word"));
        /**
        ...
        cluster.submitTopology(WordCountTopology.class.getSimpleName(), stormConf, builder.createTopology());
        
        Thread.sleep(20000);
        
        cluster.killTopology(WordCountTopology.class.getSimpleName());
        cluster.shutdown();
    }
}
